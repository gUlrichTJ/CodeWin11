...
import 'package:test_of_codes/other/pages/dart/appbar.dart';
import 'package:test_of_codes/other/pages/dart/load_file.dart';
import 'package:test_of_codes/other/pages/dart/tts.dart';
...
class _OurHomePageState extends State<OurHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar().returnCustomAppBar(), /// We receive
      /// the appBar from the custom appBar class
