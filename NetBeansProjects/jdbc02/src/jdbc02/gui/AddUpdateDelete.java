    ...
    public AddUpdateDelete(Utilisateurs utilisateurs) {
        ...
        ajouterU.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                AjouterSupprimerModifier ajouterUser = new AjouterSupprimerModifier(16, "Kodjo", "Kouma", "grh@gmail.com", "Etudiant", 17, "M", utilisateurs);
            }
        });
        ...
        modifierU.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                AjouterSupprimerModifier modifierUser = new AjouterSupprimerModifier("Modification", utilisateurs); 
            }
        });
        ...
        supprimerU.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                AjouterSupprimerModifier modifierUser = new AjouterSupprimerModifier("Supprimer", "Supprimer", utilisateurs); 
            }
        });
