...
public class VerticalMenuBar8 extends JFrame {

    // Constructor
    public VerticalMenuBar8() {
        ...
        menuBar.setLayout(new FlowLayout(FlowLayout.LEFT)); // Utiliser un FlowLayout avec alignement à gauche
    ...
    // Méthode pour créer et ajouter un JMenu avec mots penchés (JMenuItem) au JMenuBar
    private void addVerticalMenu(JMenuBar menuBar, String text) {
        JMenu menu = new VerticalMenu(text);
        menuBar.add(menu);
    }

    // Classe personnalisée pour le JMenu avec mots penchés (JMenuItem)
