...
public class Authentication extends JFrame implements JTotal {
   ...
   JPanel login() {
      ...
      greatLoginLabel.setFont(
            new Font("Arial", Font.BOLD, totalSize * 4)
      );
      ...
      usernameField.setFont(new Font("Arial", Font.PLAIN, totalSize + 5));
      ...
      passwordField.setFont(new Font("Arial", Font.PLAIN, totalSize + 5));
