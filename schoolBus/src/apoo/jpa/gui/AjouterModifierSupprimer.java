 ...
 * @author Time Store
 */
public class AjouterModifierSupprimer extends JFrame {
    ...
    public AjouterModifierSupprimer(int id, String nom, String prenom, String adresse, String profession, int age, String sexe, Utilisateurs utilisateurs) {
    ...
    public AjouterModifierSupprimer (String modifier, Utilisateurs utilisateurs) {
        this.utilisateurs = utilisateurs;
    ...
    public AjouterModifierSupprimer (String supprimer, String suppression, Utilisateurs utilisateurs) {
        this.utilisateurs = utilisateurs;
    ...
    public JPanel ajouterOuAnnuler(String nomBouton) {
        ...
        annuler.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                AjouterModifierSupprimer.this.dispose();
            }
        });
